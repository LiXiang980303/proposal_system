...
<head>
  ...
  <script type="text/javascript">
		...
		function fnAddComboTr(obj)
		{
		    ...
		    new_td_node1.innerHTML = '<td><input type="text" class="easyui-textbox" value="'+obj.value+'" name="'+obj.name+'" placeholder="选项值" style="width:100px"></td>';
...
<div class="easyui-panel">
    <table cellpadding="5">
     <tr>
        <td>字段名称</td>
        <td><input type="text" class="easyui-textbox" style="width:100px" id="fieldname" placeholder="必填项"></td>
    </tr>
    <tr>
        <td>字段标题</td>
        <td><input type="text" class="easyui-textbox" style="width:100px" id="orgname" placeholder="必填项"></td>
    </tr>
     <tr>
        <td>流程变量</td>
...
<script type="text/javascript">
	...
	function onok (){
	    ...
	    var gTitle=$('#orgname').textbox('getValue'); //$G('orgname').value;
	    var gName=$('#fieldname').textbox('getValue');//$G('fieldname').value;
	...
	$(document).ready(function(){
		if( UE.plugins[thePlugins].editdom ){
	        ...
	        $('#fieldname').textbox('setValue',oNode.getAttribute('fieldname')) ;
	        if (gFlow == '1')
	        {
