    ...
    <script type="text/javascript">
	    ...
	    var prop = {"rows":[
            {"name":"字段名称","id":"zt_columnname","value":"","group":"业务对象属性","editor":{
         	...
         	{"name":"多个文件","id":"zt_multiple","value":"false","group":"独立属性","editor":{
         		"type":"checkbox",
         		"options":{
         			"on":true,
         			"off":false
...
<body style="margin:0;padding:0;" >
	...
	<script type="text/javascript">
		...
		function onok (){
	        ...
	        ed = $('#dg').propertygrid('getEditor',{index:propmap.zt_multiple,field:'value'});
	        $(oNode).attr('multiple',$(ed.target).prop('checked'));
	        /*
		...
		function init(){
			...
			if(proploaded){
			    ...
			    if( UE.plugins[thePlugins].editdom ){
		    		...
		    		ed = $('#dg').propertygrid('getEditor',{index:propmap.zt_multiple,field:'value'});
		    		if(gMultiple && gMultiple != ""){
		    			$(ed.target).prop('checked',gMultiple == 'multiple');
		    		}
