...
UE.plugins['text'] = function () {
	...
	var popup = new baidu.editor.ui.Popup( {
		...
		_edittext: function () {
			  ...
			  var tmp = '';
			  if($(baidu.editor.plugins[thePlugins].editdom).parents("[plugins='listformctrl']").attr('plugins')){
				  tmp += '?listbizid='+$(baidu.editor.plugins[thePlugins].editdom).parents("[plugins='listformctrl']").attr('listbizid');
			  }
			  $('#ifd').attr("src",me.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/text.jsp'+tmp);
			  //$('#ifd').attr("src",me.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/text.jsp');
...
UE.plugins['button'] = function () {
	...
	var popup = new baidu.editor.ui.Popup( {
		...
		_edittext: function () {
			  baidu.editor.plugins[thePlugins].editdom = popup.anchorEl;
			  $('#ifd').attr("src",me.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/button.jsp');
			  //me.execCommand(thePlugins);
			  this.hide();
		},
		_delete:function(){
...
UE.plugins['radios'] = function () {
    ...
    var popup = new baidu.editor.ui.Popup( {
        ...
        _edittext: function () {
              baidu.editor.plugins[thePlugins].editdom = popup.anchorEl;
			  $('#ifd').attr("src",me.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/radios.jsp');
              //me.execCommand(thePlugins);
              this.hide();
        },
        _delete:function(){
...
UE.plugins['checkboxs'] = function () {
    ...
    var popup = new baidu.editor.ui.Popup( {
        ...
        _edittext: function () {
              baidu.editor.plugins[thePlugins].editdom = popup.anchorEl;
              $('#ifd').attr("src",me.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/checkboxs.jsp');
              //me.execCommand(thePlugins);
              this.hide();
        },
        _delete:function(){
...
UE.plugins['select'] = function () {
    ...
    var popup = new baidu.editor.ui.Popup( {
        ...
        _edittext: function () {
              baidu.editor.plugins[thePlugins].editdom = popup.anchorEl;
              $('#ifd').attr("src",me.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/select.jsp');
             // me.execCommand(thePlugins);
              this.hide();
        },
        _delete:function(){
...
UE.plugins['listformctrl'] = function () {
    var me = this,thePlugins = 'listformctrl';
    myme = me;
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
    ...
    var popup = new baidu.editor.ui.Popup( {
        ...
        _edittext: function () {
              baidu.editor.plugins[thePlugins].editdom = popup.anchorEl;
              $('#ifd').attr("src",me.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/listformctrl.jsp');
              //me.execCommand(thePlugins);
              this.hide();
        },
        _delete:function(){
...
UE.plugins['file'] = function () {
	...
	var popup = new baidu.editor.ui.Popup( {
		...
		_edittext: function () {
			  baidu.editor.plugins[thePlugins].editdom = popup.anchorEl;
			  $('#ifd').attr("src",me.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/file.jsp');
			  //me.execCommand(thePlugins);
			  this.hide();
		},
		_delete:function(){
...
UE.plugins['slider'] = function () {
	var me = this,thePlugins = 'slider';
	myme = me;
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
	...
	var popup = new baidu.editor.ui.Popup( {
		...
		_edittext: function () {
			  baidu.editor.plugins[thePlugins].editdom = popup.anchorEl;
			  $('#ifd').attr("src",me.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/slider.jsp');
			  //me.execCommand(thePlugins);
			  this.hide();
		},
		_delete:function(){
	...
	me.addListener('mouseover', function( t, evt ) {
		...
		if ( /input/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
			var html = popup.formatHtml(
				'<nobr>滑块: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
			if ( html ) {
				popup.getDom( 'content' ).innerHTML = html;
				popup.anchorEl = el;
				popup.showAnchor( popup.anchorEl );
...
UE.plugins['combotree'] = function () {
	...
	var popup = new baidu.editor.ui.Popup( {
		...
		_edittext: function () {
			  baidu.editor.plugins[thePlugins].editdom = popup.anchorEl;
			  $('#ifd').attr("src",me.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/combotree.jsp');
			  //me.execCommand(thePlugins);
			  this.hide();
		},
		_delete:function(){
...
UE.plugins['usertree'] = function () {
	var me = this,thePlugins = 'usertree';
	myme = me;
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
	...
	var popup = new baidu.editor.ui.Popup( {
		...
		_edittext: function () {
			  ...
			  baidu.editor.plugins[thePlugins].editdom = popup.anchorEl;
			  $('#ifd').attr("src",me.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/usertree.jsp');
			  //me.execCommand(thePlugins);
			  this.hide();
		},
		_delete:function(){
	...
	me.addListener('mouseover', function( t, evt ) {
		...
		if ( /input/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
			var html = popup.formatHtml(
				'<nobr>用户控件: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
			if ( html ) {
				popup.getDom( 'content' ).innerHTML = html;
				popup.anchorEl = el;
				popup.showAnchor( popup.anchorEl );
...
UE.plugins['avatar'] = function () {
	var me = this,thePlugins = 'avatar';
	myme = me;
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
	...
	var popup = new baidu.editor.ui.Popup( {
		...
		_edittext: function () {
			  baidu.editor.plugins[thePlugins].editdom = popup.anchorEl;
			  $('#ifd').attr("src",me.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/avatar.jsp');
			  //me.execCommand(thePlugins);
			  this.hide();
		},
		_delete:function(){
	...
	me.addListener('mouseover', function( t, evt ) {
		...
		if ( /input/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
			var html = popup.formatHtml(
				'<nobr>头像: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
			if ( html ) {
				popup.getDom( 'content' ).innerHTML = html;
				popup.anchorEl = el;
				popup.showAnchor( popup.anchorEl );
...
UE.plugins['label'] = function () {
	...
	var popup = new baidu.editor.ui.Popup( {
		...
		_edittext: function () {
			  baidu.editor.plugins[thePlugins].editdom = popup.anchorEl;
			  $('#ifd').attr("src",me.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/label.jsp');
			  //me.execCommand(thePlugins);
			  this.hide();
		},
		_delete:function(){
	...
	me.addListener('mouseover', function( t, evt ) {
		...
		if ( /label/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
			var html = popup.formatHtml(
				'<nobr>值标签: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
			if ( html ) {
				popup.getDom( 'content' ).innerHTML = html;
				popup.anchorEl = el;
				popup.showAnchor( popup.anchorEl );
